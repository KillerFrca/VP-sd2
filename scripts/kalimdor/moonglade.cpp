...
bool EffectDummyCreature_npc_clintar_dw_spirit(Unit *pCaster, uint32 spellId, SpellEffectIndex uiEffIndex, Creature *pCreatureTarget)
{
    //always check spellid and effectindex
    if (spellId == SPELL_EMERALD_DREAM && uiEffIndex == EFFECT_INDEX_0)
    {
